...
export const onRequest = async (context, next) => {
    if (context.url.pathname.includes("lessons") > 0) {
        ...
        var updatedHtml = html.replace("YT Playlist Zen", playlistData.title).replaceAll("META TITLE", playlistData.title).replaceAll("META IMAGE", playlistData.playlistThumbnail);
